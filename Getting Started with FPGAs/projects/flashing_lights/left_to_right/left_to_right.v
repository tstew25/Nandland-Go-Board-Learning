module Left_To_Right #(parameter CLOCK_COUNT = 25000000) (
	input			i_Clk,
	...
	// assign led based on selector bits
	assign o_LED[0] = !r_Select[0] && !r_Select[1] ? 1'b1 : 1'b0;
	assign o_LED[1] = r_Select[0] && !r_Select[1] ? 1'b1 : 1'b0;
	assign o_LED[2] = !r_Select[0] && r_Select[1] ? 1'b1 : 1'b0;
	assign o_LED[3] = r_Select[0] && r_Select[1] ? 1'b1 : 1'b0;
